                ...
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex items-center justify-between">
                            <div>
                                <h6 class="dark:text-white font-bold text-lg mb-0">Tambah Tahun Ajar</h6>
                                <p class="text-sm text-slate-500 dark:text-slate-400 mb-0">Buat periode tahun ajaran baru.
                                </p>
                            </div>
                    ...
                    <div class="flex-auto p-6">
                        <form action="{{ route('admin.tahun-ajar.store') }}" method="POST">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    <div
                                        class="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <h6 class="font-bold text-slate-700 dark:text-white text-sm mb-1">Status
                                                    Aktif</h6>
                                                <p class="text-xs text-slate-500 dark:text-slate-400">Jadikan tahun ajar ini
                                                    sebagai periode aktif saat ini.</p>
                                            </div>
                                            <div
                                                class="relative inline-block w-12 mr-2 align-middle select-none transition duration-200 ease-in">
                                                <input type="checkbox" name="aktif" id="toggle" {{ old('aktif') ? 'checked' : '' }}
                                        ...
                                        @if ($hasActive)
                                            <div
                                                class="mt-3 flex items-start text-yellow-600 dark:text-yellow-500 text-xs bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded">
                                                <i class="fas fa-exclamation-triangle mr-2 mt-0.5"></i>
                                                <span>Peringatan: Sudah ada Tahun Ajar yang aktif. Mengaktifkan tahun ini akan
                                                    menonaktifkan tahun lainnya jika validasi mengizinkan, atau nonaktifkan
                                                    manual terlebih dahulu.</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
