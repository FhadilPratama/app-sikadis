      ...
      <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
        ...
        @auth
          <li class="flex items-center">
            <span class="text-sm font-semibold text-white mr-4">{{ auth()->user()->name }}</span>
            <form action="{{ route('logout') }}" method="POST" class="inline">
              @csrf
              <button type="submit"
                class="block px-0 py-2 text-sm font-semibold text-white transition-all ease-nav-brand bg-transparent border-0 cursor-pointer">
          ...
          <ul dropdown-menu
            ...
            <li class="relative mb-2">
              <a class="dark:hover:bg-slate-900 ease py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-gray-200 hover:text-slate-700 lg:transition-colors"
                ...
                <div class="flex py-1">
                  <div class="my-auto">
                    <div class="inline-flex items-center justify-center mr-4 text-white bg-blue-500 h-9 w-9 rounded-xl">
                      <i class="fas fa-user text-sm"></i>
                    </div>
                  </div>
                  <div class="flex flex-col justify-center">
                    <h6 class="mb-1 text-sm font-normal leading-normal dark:text-white">
                      <span class="font-semibold">Pesan Baru</span> dari Admin
                    </h6>
            ...
            <!-- New album placeholder replaced with System Notification -->
            <li class="relative mb-2">
              <a class="dark:hover:bg-slate-900 ease py-1.2 clear-both block w-full whitespace-nowrap rounded-lg px-4 transition-colors duration-300 hover:bg-gray-200 hover:text-slate-700"
                ...
                <div class="flex py-1">
                  <div class="my-auto">
                    <div
                      class="inline-flex items-center justify-center mr-4 text-white bg-emerald-500 h-9 w-9 rounded-xl">
                      <i class="fas fa-bullhorn text-sm"></i>
                    </div>
                  </div>
                  <div class="flex flex-col justify-center">
                    <h6 class="mb-1 text-sm font-normal leading-normal dark:text-white">
                      <span class="font-semibold">Info</span> Sinkronisasi Selesai
                    </h6>
                    <p class="mb-0 text-xs leading-tight text-slate-400 dark:text-white/80">
                      <i class="mr-1 fa fa-clock"></i>
                      1 Hari lalu
